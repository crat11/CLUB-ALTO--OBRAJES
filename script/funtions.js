...
*/
            ...
            if ($(".inspiro-slider").length > 0) {
                $(".inspiro-slider").each(function () {
                    var elem = $(this),
                        ...
                        carouselAutoPlay = elem.attr('data-autoplay') || true,//false
                        carouselAutoplayTimeout = elem.attr('data-autoplay-timeout') || 4000,//5000
    ...
    INSPIRO.elements = {
        ...
        animations: function () {
            if (dataAnimation.length > 0 && $body.hasClass('device-lg') || $body.hasClass('device-md') || $body.hasClass('device-sm')) {
        ...
        contactForm: function () {
            ...
            if ($contactForm.length > 0) {
                ...
                $contactForm.each(function () {
                    var elem = $(this),
                        elemSuccessMessage = elem.attr('data-success-message') || "Hemos <strong>exitÃ³samente</strong> recibido tu mensaje. Pronto nos pondremos en contacto contigo.";
        ...
        subscribeForm: function () {
            ...
            if ($subscribeForm.length > 0) {
                ...
                $subscribeForm.each(function () {
                    var elem = $(this),
                        elemSuccessMessage = elem.attr('success-message') || "Te has suscrito exitÃ³samente a nuestro boletÃ­n informativo.";
